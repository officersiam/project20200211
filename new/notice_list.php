							...
							<div class="col">
								<section class="card">
									<header class="card-header">
										...
										<h2 class="card-title">সকল নোটিশ</h2>
									</header>
									<div class="card-body">
								<div class="row">
									<div class="col-sm-6">
										<div class="mb-3">
											<a href="add_notice.php" class="btn btn-primary">Add <i class="fas fa-plus"></i></a>
										</div>
									</div>
								</div>
  ...
  <?php
   ...
   ?>
												<tr data-item-id="<?php echo $id; ?>">
									              ...
									              <td><?php echo $date; ?></td>
											      <td><a href="update_notice.php?id=<?php echo $id; ?>"><i class="fas fa-pencil-alt"></i></a></td>
												</tr>
<?php }} ?>
											</tbody>
										</table>

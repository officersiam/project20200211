							...
							<div class="col">
								<section class="card">
									<header class="card-header">
										...
										<h2 class="card-title">সকল শিক্ষকগণ</h2>
									</header>
									<div class="card-body">
								<div class="row">
									<div class="col-sm-9">
									...
									<div class="col-sm-3">
										<div class="mb-3">
											<a href="teacher_excel.php" class="btn btn-primary">Export Phone Numbers <i class="fas fa-table"></i></a>
										</div>
									</div>
								</div>

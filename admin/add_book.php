...
<?php include ("aside.php"); ?>
				...
				<section role="main" class="content-body">
					<header class="page-header">
						...
						<div class="right-wrapper text-right">
							<ol class="breadcrumbs">
								...
								<li><span>নতুন বুকলিস্ট যোগ</span></li>
							</ol>
					...
					<!-- start: page -->
						<div class="row">
							<div class="col">
					          <form class="form-signin user" method="post" accept-charset="UTF-8" action="book_list.php">
...
<?php } ?>
					            ...
					            <textarea type="text" name="books" class="summernote" data-plugin-summernote data-plugin-options='{ "height": 180, "codemirror": { "theme": "ambiance" } }'></textarea><br/>

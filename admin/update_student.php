...
<?php include ("aside.php"); ?>
  ...
  <?php
    $sql = $db->query("SELECT * FROM users WHERE id = '$id' ORDER BY roll DESC");
   ...
   ?>
                  ...
                  <tbody>
                  <form class="form-signin user" method="post" accept-charset="utf-8" action="update_student.php?id=<?php echo $id; ?>">
                    <tr>
                      <td><b>আইডি:</b></td>
                      <td><?php echo $id; ?></td>
              ...
              <button class="btn btn-primary btn-user btn-block" name="student_update" type="submit">আপডেট</button>
                    ...
                    <tr>
                      <td>
                        <form class="form-signin user" method="post" accept-charset="utf-8" action="class_details.php?class=<?php echo $class; ?>">
                      ...
                      <td>
                        <form class="form-signin user" method="post" enctype="multipart/form-data" action="update_student.php?id=<?php echo $id; ?>">
                          <input type="text" name="id" class="form-control form-control-user" value="<?php echo $id; ?>" hidden>

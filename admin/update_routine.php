...
<?php include ("aside.php"); ?>
  ...
  <?php
    $sql = $db->query("SELECT * FROM class_routine WHERE id = '$id' ");
   ...
   ?>
                  ...
                  <tbody>
                  <form class="form-signin user" method="post" accept-charset="utf-8" action="class_routine.php?class=<?php echo $class;?>">

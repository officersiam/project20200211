...
<?php include ("aside.php"); ?>
				...
				<section role="main" class="content-body">
					<header class="page-header">
						<h2>শ্রেণিভিত্তিক নতুন স্টেশনারীর যোগ</h2>
						...
						<div class="right-wrapper text-right">
							<ol class="breadcrumbs">
								...
								<li><span>শ্রেণিভিত্তিক নতুন স্টেশনারীর যোগ</span></li>
							</ol>
					...
					<!-- start: page -->
					    ...
					    <?php } ?>
					            ...
					            <textarea type="text" name="details" class="summernote" data-plugin-summernote data-plugin-options='{ "height": 180, "codemirror": { "theme": "ambiance" } }'></textarea><br/>

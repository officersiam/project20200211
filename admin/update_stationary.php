...
<?php include ("aside.php"); ?>
					...
					<header class="page-header">
						...
						<div class="right-wrapper text-right">
							<ol class="breadcrumbs">
								...
								<li><span>স্টেশনারী আপডেট</span></li>
							</ol>
  ...
  <?php
    $sql = $db->query("SELECT * FROM class_stationary WHERE id = '$id' ORDER BY id");
   ...
   ?>
                  ...
                  <form class="form-signin user" method="post" accept-charset="utf-8" action="class_stationary_list.php?class=<?php echo $class;?>">
                    ...
                    <tr>
                      <td><b>বিস্তারিত:</b></td>
                      <td><textarea type="text" name="details" class="summernote" data-plugin-summernote data-plugin-options='{ "height": 180, "codemirror": { "theme": "ambiance" } }'><?php echo $details; ?></textarea></td>
                    </tr>
                    <tr>
                      <td><b>Date:</b></td>
                      <td><?php echo $date; ?></td>

...
<?php include ("aside.php"); ?>
				...
				<section role="main" class="content-body">
					<header class="page-header">
						...
						<div class="right-wrapper text-right">
							<ol class="breadcrumbs">
								...
								<li><span>নতুন নোটিশ যোগ</span></li>
							</ol>
					...
					<!-- start: page -->
						<div class="row">
							<div class="col">
					          <form class="form-signin user" method="post" enctype="multipart/form-data" accept-charset="UTF-8" action="notice_list.php">
					            ...
					            <textarea type="text" name="notice_details" class="summernote" data-plugin-summernote data-plugin-options='{ "height": 180, "codemirror": { "theme": "ambiance" } }'></textarea><br/>
					            ...
					            <input type="text" name="lebel" class="form-control form-control-user" value="home"><br/>

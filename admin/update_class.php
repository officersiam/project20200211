...
<?php include ("aside.php"); ?>
   ...
   <?php
    $sql = $db->query("SELECT * FROM classes WHERE id = '$id' ORDER BY id");
   ...
   ?>
                  ...
                  <form class="form-signin user" method="post" accept-charset="utf-8" action="classes_list.php">
                    ...
                    <tr>
                      <td><b>বিস্তারিত:</b></td>
                      <td><textarea type="text" name="class_details" class="summernote" data-plugin-summernote data-plugin-options='{ "height": 180, "codemirror": { "theme": "ambiance" } }'><?php echo $class_details; ?></textarea></td>
                    </tr>
                    <tr>
                      <td><b>লেবেল:</b></td>

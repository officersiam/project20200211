...
<?php include ("aside.php"); ?>
					...
					<header class="page-header">
						...
						<div class="right-wrapper text-right">
							<ol class="breadcrumbs">
								...
								<li><span>বুকলিস্ট আপডেট</span></li>
							</ol>
  ...
  <?php
    $sql = $db->query("SELECT * FROM booklist WHERE id = '$id' ");
   ...
   ?>
						                  ...
						                  <form class="form-signin user" method="post" accept-charset="utf-8" action="<?php echo $_SERVER['PHP_SELF']; ?>">
						                    ...
						                    <tr>
						                      <td><b>বিস্তারিত:</b></td>
						                      <td><textarea type="text" name="books" class="summernote" data-plugin-summernote data-plugin-options='{ "height": 180, "codemirror": { "theme": "ambiance" } }'><?php echo $books; ?></textarea></td>
						                    </tr>
						                    <tr>
						                      <td><b>Date:</b></td>
						                      <td><?php echo $date; ?></td>

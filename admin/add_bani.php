					...
					<!-- start: page -->
						<div class="row">
							<div class="col">
					            ...
					            <textarea type="text" name="principle_msg" class="summernote" data-plugin-summernote data-plugin-options='{ "height": 180, "codemirror": { "theme": "ambiance" } }'></textarea><br/>

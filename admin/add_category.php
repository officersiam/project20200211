...
<?php include ("aside.php"); ?>
				...
				<section role="main" class="content-body">
					<header class="page-header">
						...
						<div class="right-wrapper text-right">
							<ol class="breadcrumbs">
								...
								<li><span>নতুন ক্যাটেগরীর যোগ</span></li>
							</ol>
					...
					<!-- start: page -->
						<div class="row">
							<div class="col">
							    <form class="form-signin user" method="post" enctype="multipart/form-data" accept-charset="UTF-8" action="category_list.php">
